...
-- 1. REPAIR SCHEMA (DDL)
-- Ensure all necessary columns exist. This fixes missing 'name' or other columns.
...
-- Ensure 'category' column exists (as Text) to store the Category ID
...
-- 3. CLEAR OLD ITEMS
-- Clear items in these categories to avoid duplicates
